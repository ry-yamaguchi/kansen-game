...
export const CONFIG = {
  ...
  inflowCountStart: 1,
  // 入口を駅だけから駅＋バス停3か所にしたら、角のバス停から来た人は人の集まりに届くまでに時間がかかり、
  // 上手な打ち方の崩壊が減った（2026-09-26）。終盤に一度に来る人数を3→4に増やして、終盤の緊張を戻す
  inflowCountEnd: 4,
  /** 人数の上限。増えすぎて重くならないようにする */
  maxPopulation: 130,
  /**
   * 到着が駅から来る割合。残りはバス停3か所に均等に分かれる。
   * 入口を1つ塞いでも、人は別の入口から入ってくる（研究メモ F1）
   */
  inflowStationShare: 0.5,
  /** バス停からの到着は、停留所の位置から通りの幅 × この比率だけ、縦横それぞれにばらけて現れる */
  busStopJitterRatio: 0.2,
